...
To calculate this time value for each solver, we find the time at which 99\% of the solver's total number of \texit{Valid / Invalid / Unknown} responses have be returned. 
