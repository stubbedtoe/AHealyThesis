...
The limitations of our approach has been commented on in the paragraph beginning \emph{``Options for the extraction..."} in Sec. 3.2.1.
These limitations were previously referenced in the Internal Threats to Validity in Chapter 6.
Other approaches to feature extraction have been added to the discussion of future work in Chapter 7 (see Comment \ref{future}).  
...
The paper on meta-inductive learning (iii) is similar to the group's other work on tactic learning previously cited so I added it to the list of the groups output in the sentence beginning \emph{``Much of the group's..."}.
...
(i) This approach was already included in the discussion on future work: see the paragraph beginning \emph{``Applying multiple solvers in parallel..."}. (ii) This comparison has been incorporated into the new version of the thesis (see Comment \ref{presolving}). (iii) This point is acknowledged in the paragraph beginning \emph{``One of the limitations..."}.
