...
(i) This approach was already included in the discussion on future work: see the paragraph beginning \emph{``Applying multiple solvers in parallel..."}. (ii) This comparison has been incorporated into the new version of the thesis (see Correction \ref{presolving}). (iii) This point is acknowledged in the paragraph beginning \emph{``One of the limitations..."}.
