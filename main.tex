...
\usepackage[backend=bibtex, natbib=true]{biblatex} %,style=authoryear,natbib=true]{biblatex} % Use the bibtex backend with the authoryear citation style (which resembles APA)
