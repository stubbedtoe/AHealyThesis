...
""".format(title='Predictor Selection',
	...
	with open('table_4_4_compare_regressors.tex', 'w') as f:
		f.write(txt)
	
	command = "pdflatex -synctex=1 -interaction=nonstopmode table_4_4_compare_regressors.tex"
	call(command.split(), shell=False)
	os.remove('table_4_4_compare_regressors.aux')
	os.remove('table_4_4_compare_regressors.log')
	os.remove('table_4_4_compare_regressors.synctex.gz')
	# the first few
	print(rv.head(10))
